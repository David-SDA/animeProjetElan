...
-- Listage des données de la table animeprojetelan.user : ~6 rows (environ)
INSERT INTO `user` (`id`, `email`, `pseudo`, `date_inscription`, `image_profil`, `date_naissance`, `pays`, `ville`, `description`, `est_visible`, `roles`, `password`, `is_verified`, `est_banni`) VALUES
	(1, 'user1@user1.com', 'user1', '2023-09-01 06:56:03', NULL, NULL, NULL, NULL, NULL, 1, '[]', '$2y$13$WHk4q3eXyVLBG6rmt.OvOezh0gsW1iu7nYAFjtNakfIEIwmfM8B3m', 0, 0),
	(2, 'user2@user2.com', 'user2', '2023-09-01 07:00:13', NULL, NULL, NULL, NULL, NULL, 1, '[]', '$2y$13$NKDfkWnxZ8FLs1P63GHscO6Ad0Vcgi/Q6msLS50H913z7M9NQvrPC', 0, 0),
	...
	(5, 'user4@user4.com', 'user4', '2023-09-01 07:19:59', NULL, NULL, NULL, NULL, NULL, 1, '[]', '$2y$13$Mk8FeUNfSexvRysP.zV77eIrER6Oa7gNj31NjNgLq/WxQUFDd52vi', 0, 0),
	(6, 'user5@user5.com', 'user5', '2023-09-01 08:35:53', NULL, NULL, NULL, NULL, NULL, 1, '[]', '$2y$13$G7onYkk8669blLK8GhVpdeGXlBSsjVBj283/iqUQsCJjrdhVWknai', 0, 0),
	(7, 'user6@user6.com', 'user6', '2023-09-01 13:46:28', NULL, NULL, NULL, NULL, NULL, 1, '[]', '$2y$13$DSa2Ij.6u6MFXDP8avfbPeILFUTEId3UsbLIYcgO64A.SH78ix8ma', 0, 0);
